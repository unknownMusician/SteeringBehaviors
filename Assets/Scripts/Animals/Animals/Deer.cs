...
namespace SteeringBehaviors.Animals.Animals
{
    public sealed class Deer : Animal
    {
        ...
        public Deer(
            ...
            : base(new AnimalInfo(mover, transform, new AnimalBehaviourSettings(
                animalsBehaviourSettings.DeerDetectionRadius, 
                animalsBehaviourSettings.DeerDetectionLayers)))
        {
